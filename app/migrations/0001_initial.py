...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('avatar', models.ImageField(max_length=256, upload_to='avatars/', verbose_name='Avatar')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(verbose_name='Main text')),
                ('publishing_date', models.DateField(default=datetime.date.today, verbose_name='Publishing date')),
                ('rating', models.IntegerField(default=0, verbose_name='Amount of likes')),
